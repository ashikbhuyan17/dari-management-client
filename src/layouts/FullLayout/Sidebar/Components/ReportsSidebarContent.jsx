        ...
        <Collapse in={openReportDropdown} timeout="auto" unmountOnExit>
          <List component="div" disablePadding>
            <ListItem 
              button 
              style={{ 
              backgroundColor: pathname === '/report/raw-material/increase' ? activeColor : inactiveColor, 
              color:  pathname !== '/report/raw-material/increase' ? inactiveTextColor : activeTextColor,paddingLeft: "4em"}}
              onClick={()=> {return navigate('/report/raw-material/increase')}}>
              <ListItemIcon>
                <ArrowRightAltIcon />
              </ListItemIcon>
              <ListItemText primary="Raw Material Increase" />
            </ListItem>
            <ListItem 
              button 
              style={{ 
