...
const ProductCategories = () => {
  ...
  const getProductCategoryList = async () => {
    const response = await axios.get(`https://young-harbor-43911.herokuapp.com/api/category/getCategory`, { headers: { Authorization: `Bearer ${getAccessToken()}` } });
  ...
  const deleteProductCategoryList = async (id) => {
    console.log(id)
    const response = await axios.delete(`https://young-harbor-43911.herokuapp.com/api/category/deleteCategory/${id}`, { headers: { Authorization: `Bearer ${getAccessToken()}` } });
    console.log("getProductCategoryList", response)
    if (response.status === 200) {
  ...
  const postCategory = useCallback(async () => {
    if (category === "") {
      ...
      const response = await axios.post(`https://young-harbor-43911.herokuapp.com/api/category/create`, data, { headers: { Authorization: `Bearer ${getAccessToken()}` } });
